...
def _insert_payslip(db: Session, payload: dict[str, Any], source_key: str, currency: str, sync_log_id: str) -> bool:
    ...
    payslip = Payslip(
        ...
        pay_period_start=_safe_date(payload.get("pay_period_start") or payload.get("period_start")),
        pay_period_end=_safe_date(payload.get("pay_period_end") or payload.get("period_end")),
        currency=currency,
